...
export default function ToppingFilter({ activeTopping }) {
  ...
  // Get a list of all pizza with their toppings
  ...
  // Loop over the list of toppings and display teh topping and the count of pizzas in that topping
